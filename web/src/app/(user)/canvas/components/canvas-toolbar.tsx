    ...
    return (
        <div className="pointer-events-none absolute bottom-5 z-50 flex justify-center" style={{ left: 300, right: 16 }}>
            ...
            <div ref={wrapRef} className="thin-scrollbar pointer-events-auto flex h-14 max-w-full items-center gap-1 overflow-x-auto rounded-xl border px-2 shadow-lg backdrop-blur [&>*]:shrink-0" style={dockStyle}>
                ...
                <Divider theme={theme} />
                <ToolbarButton id="tool-clear" label="清空灵感" hovered={hovered} hoverStyle={hoverStyle} wrapRef={wrapRef} onTipX={setTipX} onHover={setHovered} onClick={onClear} danger>
            ...
            {appearanceOpen ? (
                ...
                >
                    <div className="px-1 pb-2 text-sm font-medium opacity-65">灵感外观</div>
...
function toolLabel(id: string) {
    ...
    if (id === "tool-style") return "灵感外观";
    if (id === "tool-delete") return "删除选中";
    if (id === "tool-clear") return "清空灵感";
    return "";
}
